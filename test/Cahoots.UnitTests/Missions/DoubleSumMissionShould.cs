...
{
    public class DoubleSumMissionShould
    {
        [Fact]
        public void Be_completed()
        {
            var setCollection = new List<CardSet>()
            {
                ...
                CardSetMother.Create(CardMother.Red1, CardMother.Red3, CardMother.Orange3, CardMother.Orange5),
                CardSetMother.Create(CardMother.Red7, CardMother.Blue1, CardMother.Orange7, CardMother.Orange7),
                CardSetMother.Create(CardMother.Blue3, CardMother.Red3, CardMother.Green5, CardMother.Orange6),
                CardSetMother.Create(CardMother.Blue5, CardMother.Red2, CardMother.Red1, CardMother.Orange6)
            };

            var mission = new DoubleSumMission(Color.Red, Color.Orange);
