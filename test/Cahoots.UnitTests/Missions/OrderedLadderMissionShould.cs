...
{
    public class OrderedLadderMissionShould
    {
        [Fact]
        public void Be_completed()
        {
            var setCollection = new List<CardSet>()
            {
                ...
                CardSetMother.Create(CardMother.Blue2, CardMother.Red3, CardMother.Green4, CardMother.Orange5),
                CardSetMother.Create(CardMother.Blue1, CardMother.Red2, CardMother.Green3, CardMother.Orange6),
                CardSetMother.Create(CardMother.Blue3, CardMother.Red4, CardMother.Green5, CardMother.Orange6),
                CardSetMother.Create(CardMother.Blue5, CardMother.Red2, CardMother.Green3, CardMother.Orange4),
                CardSetMother.Create(CardMother.Blue4, CardMother.Red5, CardMother.Green6, CardMother.Orange4),
                CardSetMother.Create(CardMother.Blue4, CardMother.Red5, CardMother.Green6, CardMother.Orange7),
            };

            var mission = new OrderedLadderMission(3);
        ...
        public void Not_be_completed()
        {
            var setCollection = new List<CardSet>()
           {
                ...
                CardSetMother.Create(CardMother.Blue1, CardMother.Blue2, CardMother.Blue7, CardMother.Blue3),
                CardSetMother.Create(CardMother.Blue6, CardMother.Blue2, CardMother.Blue5, CardMother.Blue4),
                CardSetMother.Create(CardMother.Blue6, CardMother.Blue7, CardMother.Blue5, CardMother.Blue4)
            };
