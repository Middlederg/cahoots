...
namespace Cahoots.Core
{
    public static class MissionFactory
    {
        ...
        public static IEnumerable<IMission> GetAllMissions()
        {
            ...
            yield return new NotNearCardsMission(2, Color.Red);
            yield return new NotNearCardsMission(2, Color.Green);
            yield return new NotNearCardsMission(2, Color.Blue);
            yield return new NotNearCardsMission(2, Color.Orange);
            ...
            yield return new NearCardsMission(2, Color.Orange);
            yield return new NearCardsMission(2, Color.Green);
            yield return new NearCardsMission(2, Color.Red);
            yield return new NearCardsMission(2, Color.Blue);
            yield return new NearCardsMission(2, Color.Red);
